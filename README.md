...
Jenkins clones the project code from a GitHub repository.

The pipeline starts several Docker containers on a dedicated network to simulate our infrastructure.

Ansible runs to provision these containers:
